 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.impl.ConditionBasedActivationGenerationMethodImpl#getConditionDepth <em>Condition Depth</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionBasedActivationGenerationMethodImpl extends ActivationGenerationMethodImpl implements ConditionBasedActivationGenerationMethod {
	...
	protected EClass eStaticClass() {
		return TestingPackagePackage.Literals.CONDITION_BASED_ACTIVATION_GENERATION_METHOD;
	}
	...
	public void setConditionDepth(int newConditionDepth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackagePackage.CONDITION_BASED_ACTIVATION_GENERATION_METHOD__CONDITION_DEPTH, oldConditionDepth, conditionDepth));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestingPackagePackage.CONDITION_BASED_ACTIVATION_GENERATION_METHOD__CONDITION_DEPTH:
