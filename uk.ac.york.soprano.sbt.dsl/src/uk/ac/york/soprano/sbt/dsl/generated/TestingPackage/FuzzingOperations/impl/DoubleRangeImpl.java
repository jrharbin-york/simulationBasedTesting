 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.FuzzingOperations.impl.DoubleRangeImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.FuzzingOperations.impl.DoubleRangeImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleRangeImpl extends ValueRangeImpl implements DoubleRange {
	...
	protected EClass eStaticClass() {
		return FuzzingOperationsPackage.Literals.DOUBLE_RANGE;
	}
	...
	public void setLowerBound(double newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FuzzingOperationsPackage.DOUBLE_RANGE__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(double newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FuzzingOperationsPackage.DOUBLE_RANGE__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FuzzingOperationsPackage.DOUBLE_RANGE__LOWER_BOUND:
				return getLowerBound();
			case FuzzingOperationsPackage.DOUBLE_RANGE__UPPER_BOUND:
