 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.NodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.NodeImpl#getSubscriber <em>Subscriber</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.NodeImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.NodeImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	 ...
	 * @ordered
	 */
	protected EList<GenericVariable> subscriber;
	 ...
	 * @ordered
	 */
	protected EList<GenericVariable> publisher;
	 ...
	 * @generated
	 */
	public EList<GenericVariable> getSubscriber() {
		if (subscriber == null) {
			subscriber = new EObjectResolvingEList<GenericVariable>(GenericVariable.class, this, MRSPackagePackage.NODE__SUBSCRIBER);
		}
		return subscriber;
	}
	 ...
	 * @generated
	 */
	public EList<GenericVariable> getPublisher() {
		if (publisher == null) {
			publisher = new EObjectResolvingEList<GenericVariable>(GenericVariable.class, this, MRSPackagePackage.NODE__PUBLISHER);
		}
		return publisher;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MRSPackagePackage.NODE__SUBSCRIBER:
				getSubscriber().clear();
				getSubscriber().addAll((Collection<? extends GenericVariable>)newValue);
				return;
			case MRSPackagePackage.NODE__PUBLISHER:
				getPublisher().clear();
				getPublisher().addAll((Collection<? extends GenericVariable>)newValue);
				return;
			case MRSPackagePackage.NODE__PROPERTIES:
				getProperties().clear();
