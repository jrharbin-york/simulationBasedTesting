 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.impl.RepeatedExecutionImpl#getTestToRepeat <em>Test To Repeat</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.impl.RepeatedExecutionImpl#getRepeatCount <em>Repeat Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RepeatedExecutionImpl extends TestGenerationApproachImpl implements RepeatedExecution {
	...
	protected EClass eStaticClass() {
		return TestingPackagePackage.Literals.REPEATED_EXECUTION;
	}
		...
		if (testToRepeat != null && testToRepeat.eIsProxy()) {
			...
			if (testToRepeat != oldTestToRepeat) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestingPackagePackage.REPEATED_EXECUTION__TEST_TO_REPEAT, oldTestToRepeat, testToRepeat));
			}
		}
		return testToRepeat;
	}
	...
	public void setTestToRepeat(Test newTestToRepeat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackagePackage.REPEATED_EXECUTION__TEST_TO_REPEAT, oldTestToRepeat, testToRepeat));
	}
	...
	public void setRepeatCount(int newRepeatCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackagePackage.REPEATED_EXECUTION__REPEAT_COUNT, oldRepeatCount, repeatCount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestingPackagePackage.REPEATED_EXECUTION__TEST_TO_REPEAT:
				if (resolve) return getTestToRepeat();
				return basicGetTestToRepeat();
			case TestingPackagePackage.REPEATED_EXECUTION__REPEAT_COUNT:
