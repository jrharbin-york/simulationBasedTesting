 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getLaunchDelaySeconds <em>Launch Delay Seconds</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getLaunchFileLocation <em>Launch File Location</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getCustomTerminateFileLocation <em>Custom Terminate File Location</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getRecordFileLocation <em>Record File Location</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getSimulator <em>Simulator</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getPropertyType <em>Property Type</em>}</li>
 *   <li>{@link uk.ac.york.soprano.sbt.dsl.generated.TestingPackage.MRSPackage.impl.MRSImpl#getExecStrategy <em>Exec Strategy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MRSImpl extends MinimalEObjectImpl.Container implements MRS {
	...
	/**
	 * The cached value of the '{@link #getExecStrategy() <em>Exec Strategy</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getExecStrategy()
	 * @generated
	 * @ordered
	 */
	protected ExecutionStrategy execStrategy;
	 ...
	 * @generated
	 */
	public ExecutionStrategy getExecStrategy() {
		return execStrategy;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExecStrategy(ExecutionStrategy newExecStrategy, NotificationChain msgs) {
		ExecutionStrategy oldExecStrategy = execStrategy;
		execStrategy = newExecStrategy;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MRSPackagePackage.MRS__EXEC_STRATEGY, oldExecStrategy, newExecStrategy);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setExecStrategy(ExecutionStrategy newExecStrategy) {
		if (newExecStrategy != execStrategy) {
			NotificationChain msgs = null;
			if (execStrategy != null)
				msgs = ((InternalEObject)execStrategy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MRSPackagePackage.MRS__EXEC_STRATEGY, null, msgs);
			if (newExecStrategy != null)
				msgs = ((InternalEObject)newExecStrategy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MRSPackagePackage.MRS__EXEC_STRATEGY, null, msgs);
			msgs = basicSetExecStrategy(newExecStrategy, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MRSPackagePackage.MRS__EXEC_STRATEGY, newExecStrategy, newExecStrategy));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MRSPackagePackage.MRS__EXEC_STRATEGY:
				return basicSetExecStrategy(null, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MRSPackagePackage.MRS__PROPERTY_TYPE:
				...
				return;
			case MRSPackagePackage.MRS__EXEC_STRATEGY:
				setExecStrategy((ExecutionStrategy)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case MRSPackagePackage.MRS__PROPERTY_TYPE:
				...
				return;
			case MRSPackagePackage.MRS__EXEC_STRATEGY:
				setExecStrategy((ExecutionStrategy)null);
				return;
		}
